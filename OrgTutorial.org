...
** DONE runing mmap() get "Segmentation fault (core dumped)"
...
finish step, the most easy way
0. groupadd raymons & hugeadm --set-shm-group raymons. of course many way can add it.
1. alloc 20 page : sudo sh -c 'echo 20 > /proc/sys/vm/nr_hugepages'
2. mount hugetlbfs : sudo mount -t hugetlbs -o mode=777 none /mnt/huge
...
** TODO test madvise for free physics page
* linux learning
