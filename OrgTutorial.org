...
** TODO back to occiiocp for citic erp <2014-11-09 Sun>
  ...
  the most crazy is sangfor ssl vpn do not support my program, i think it is Connectex, i have to use fiddler proxy
in <2014-11-09 Sun> the crazy thing is ContentPad add SHEAD more than once. after 3 hours debug, I found
  CNoneApplication::OnServerRead call CContentPad::OnServerRead in CONTENT_MODE_LENGTH, with NProcessSize == 0, 
  when it received data. It only happened in Content-Length mode, not ni Chunk mode
in <2014-11-10 Mon> finish 20001 and 20002, and change SHEAD to SHEA-contentanme
** TODO goon epoll test
*** reread my code <2014-12-31 Wed>
** TODO read redis <2015-01-11 Sun>
** TODO read libev, libevent, libuv <2015-01-15 Thu>
** TODO prepare for iocp in linux <2015-01-16 Fri>
...
* Redis
** Command [[http://redis.io/commands][redis commands]]
*** Connected
PING / PONG
SELECT / config get databases for list
** useful link
[[http://labs.alcacoop.it/doku.php?id%3Darticles:redis_land][Very begin, relation to set]]
[[http://www.rediscookbook.org/][Redis cookbook]]
[[http://vdisk.weibo.com/s/ACnSNeFyxHO1][The disign and implementation of Redis]] book only few chapter
[[http://events.linuxfoundation.org/sites/events/files/alss13_gregkh.pdf][kdbus ?]]
[[http://libev.schmorp.de/bench.html][bench for libev & libevent]]
[[http://doc.dvgu.ru/devel/ev.html][libev]]
[[http://comments.gmane.org/gmane.comp.lib.ev/2353][libev support file via pipes/stdin]]
** Source
<2015-01-13 Tue>
version.h                                                               记录了 Redis 的版本号。"2.9.11"
fmacros.h                                                               一些移植性方面的宏。
...
[[http://graphics.stanford.edu/~seander/bithacks.html][useful bit hacks]]
intset.c, intset.h                                                      整数集合数据结构的实现，用于优化 SET 类型。
hyperloglog.c          // NOT read program                              HyperLogLog 数据结构的实现。
[[http://blog.codinglabs.org/articles/cardinality-estimate-exper.html][hyper loglog]]           // I only know, what is LC, LLC, AC, HLLC
...
** Greatwall
https://github.com/greatfire/wiki/ mirror of some page
https://code.google.com/p/program-think/wiki/Books bbok of some other
https://www.torproject.org/download/download-easy.html download tor
...
| <2014-11-14 Fri> | Around RunFang       | 10 |  30 |                                        |
| <2014-11-21 Fri> | Around YinCai        |  8 |  25 |                                        |
| <2014-11-25 Tue> | To WuZhong & WuJiang | 25 |  90 |                                        |
| <2014-11-25 Tue> | From WuJiang         | 22 | 120 | so tried                               |

* evalution
| Date             | Place            | Agent      |   M | What                                         | cost      |
|------------------+------------------+------------+-----+----------------------------------------------+-----------|
| before 4 time    |                  |            |  16 |                                              | about 1.5 |
...
| <2014-11-04 Tue> | Service Center   | YuanXing   |   3 | Info. Center, 10G FW                         |           |
| <2014-11-10 Mon> | YuanXing         | YuanXing   |   8 | self, tax guarantee Hardware scheme          |           |
| <2014-11-12 Wed> | KunShan          | DingXin    | 4.5 | JinXi community monitoring                   | 1         |
| <2014-11-13 Thu> | Audit beau.      | self       |   5 | audit info                                   |           |
| <2014-11-14 Fri> | RunFang          | RunFang    |   2 | Suzhou Pub Security, intranet monitor        |           |
| <2014-11-20 Thu> | Service Center   | ZhongCheng |   3 | YuanQu Tech School, tech edu                 |           |
| <2014-11-21 Fri> | YinCai           | YinCai     |   2 | SuZhou Pub Security, 3 forprice              |           |
| <2014-11-25 Tue> | WuZhong          | ZhongCheng |   3 | ZhouShan community monitoring                |           |
| <2014-11-25 Tue> | WuJiang          | WeiYuan    | 4.5 | WuJiang Secure Supervise, Hardware           | 0.5       |
| <2014-11-27 Thu> | Service Center   | JingGang   |   3 | Suzhou Env Safe, Hardware                    | S : 90    |
| <2014-12-01 Mon> | Service Center   | YuanXing   |   3 | Suzhwou Accumulation Fund, Hardware          |           |
| <2014-12-02 Tue> | MuDu             | ZhongCheng |   2 | MuDu No3 Pri School, Computer * 25           | 0.5       |
| <2014-12-05 Fri> | WeiKang          | WeiKang    |   2 | HiTec Sec&Tech bea, Software                 |           |
| <2014-12-09 Tue> | WuZhong          | ChuangJie  |   3 | YueXi Pri School, Furture Class              | 1.5       |
| <2014-12-09 Tue> | YuanXing         | YuanXing   |   3 | XinQu Mid School, Movie Player               |           |
| <2014-12-11 Thu> | XiangCheng       | WeiYuan    |   2 | YuYao Pri School, E-broad                    |           |
| <2014-12-16 Tue> | KunShan          | JSHaiWai   |   5 | ChengXi community monitoring                 |           |
| <2014-12-18 Thu> | Service Center   | LongHua    |   3 | Suzhou Travel Bureau, Facebook               | 3 hours   |
| <2014-12-23 Tue> | KunShan          |            |   8 | 1 abandoned, 2 forprice, 1 single, 2 query   |           |
| <2014-12-26 Fri> | Service Center   | WeiKang    |   3 | Suzhou Sce. Col.                             | S : 124   |
|                  |                  |            |     |                                              |           |
* evalition2015
| Date             | Place             | Agent    |   M | What                                     | cost      |
|------------------+-------------------+----------+-----+------------------------------------------+-----------|
| <2015-01-06 Tue> | Service Center    | YuanXing |   3 | self, tax guarantee Hardware             |           |
| <2015-01-08 Thu> | Property Exchange | self     |  10 | self, exchange software                  |           |
| <2015-01-15 Thu> | KunShan           | JSHaiWai | 4.5 | BaoCheng community monitoring            | 1.5       |
| <2015-01-20 Tue> | Service Center    | RunFang  |   3 | Suzhou Public Security, population score |           |
| <2015-01-29 Thu> | Service Center    | YuanXing |   2 | Procuratorate, monitor                   | S : 22.5  |
| <2015-02-13 Fri> | Service Center    | RunFang  |   2 | Rail Transit, monitor                    |           |
| <2015-03-26 Thu> | Service Center    | Chenghe  |   2 | Audio Visual Center, monitor             | abandoned |
|                  |                   |          |     |                                          |           |
* 工作内容
** 下周安排邮储银行余额查询地址变更
