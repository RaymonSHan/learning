...
** DONE binding my keyboard, stop now, for further again.
...
** TODO detect the state of daemon, 
...
|              | h          | i          | j          | k          | l          | ;          |
|--------------+------------+------------+------------+------------+------------+------------|
| double:move  | home       | up         | left       | down       | right      | end        |
| a:speed      | pageup     | up * 3     | left * 7   | down * 3   | right * 7  | pagedown   |
| z:speed more | beginning  | up * 8     | left * 17  | down * 8   | right * 17 | end        |
| w:word sema  |            |            |            |            |            |            |
|--------------+------------+------------+------------+------------+------------+------------|
| t:tran seam  | tran Lword | tran Usent | tran Lchar | tran Dsent | tran Rchar | tran Rword |
|              |            |            |            |            |            |            |
...
** 下周安排支付中心业务需求讨论（潘鑫）
   DEADLINE: <2014-09-22 Mon>
** 下周安排人民银行，讨论TCBS上线后，集中支付退票号的关联问题
   DEADLINE: <2014-09-22 Mon>
** 非税收入入库单时间拖延，工行、瑞联
   DEADLINE: <2014-09-22 Mon>
